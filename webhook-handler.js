/**
 * Webhook Handler for Beta Signup Email Automation
 * Deploy this to Vercel, Netlify, or similar
 * 
 * Supabase will POST to this endpoint when a new opt-in is recorded
 * This function sends a welcome email via Resend
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Get opt-in data from Supabase (if available in payload)
...
function generateWelcomeEmail(name) {
  return `
    ...
    <head>
      ...
      <style>
        body { font-family: 'Manrope', sans-serif; background: #0b0f16; color: #f7efe2; margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 0 auto; padding: 40px 20px; }
        .header { text-align: center; margin-bottom: 40px; }
        .header h1 { font-family: 'Fraunces', serif; font-size: 2.5rem; color: #d9a441; margin: 0; font-weight: 700; }
